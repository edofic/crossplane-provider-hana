...
func main() {
	var (
		...
		enableManagementPolicies   = app.Flag("enable-management-policies", "Enable support for ManagementPolicies on managed resources.").Default("false").Envar("ENABLE_MANAGEMENT_POLICIES").Bool()
	)
